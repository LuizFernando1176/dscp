                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-dark ">
                            <h4 class="card-title text-center">Produto</h4>
                        ...
                        <div class="card-body ">
                            ...
                            <form action="" method="">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label><b>Caminho da Foto:</b></label> <input name="caminhoFoto" id="caminhoFoto"  class="form-control"/><br>
                                        <label><b>Preço:</b></label> <input name="preco" id="preco"  class="form-control"/><br>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <label><b>Descrição:</b></label>  <textarea name="descricao" id="descricao" class="form-control" rows="5" cols="5"></textarea><br>
