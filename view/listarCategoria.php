                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header card-header-dark ">
                            <h4 class="card-title text-center">Categoria</h4>
                            <p class="card-category text-center">Lista de Categoria do Sistema</p>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Sushi</td>
                                        <td><button type="button" rel="tooltip" title="" class="btn btn-primary btn-link btn-warning btn-lg" data-original-title="Edite Categoria">
                                                <i class="material-icons">edit</i>
                                                <div class="ripple-container"></div></button></td>
                                        <td><button type="button" rel="tooltip" title="" class="btn btn-primary btn-danger btn-link btn-lg" data-original-title="Delete Categoria">
