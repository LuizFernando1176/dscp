                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header card-header-dark ">
                            ...
                            <p class="card-category text-center">Lista de Produtos do Sistema</p>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Sushi</td>
                                        <td>Sushi de Camarão , Salmão.</td>
                                        <td>R$ 50,00</td>
                                        <td><img src="../img/Macbook.png" width="100" height="100" ></td>
                                        <td>Pratos Frios</td>
                                        <td><button type="button" rel="tooltip" title="" class="btn btn-primary btn-link btn-warning btn-lg" data-original-title="Edite Produto">
                                                <i class="material-icons">edit</i>
                                                <div class="ripple-container"></div></button></td>
                                        <td><button type="button" rel="tooltip" title="" class="btn btn-primary btn-danger btn-link btn-lg" data-original-title="Delete Produto">
