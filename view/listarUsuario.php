                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Luiz Fernando da S. Ferreira</td>
                                        <td>nando1176@hotmail.com</td>
                                        <td>Luiz Fernando</td>
                                        <td><button type="button" rel="tooltip" title="" class="btn btn-primary btn-link btn-warning btn-lg" data-original-title="Edite Usuario">
                                                <i class="material-icons">edit</i>
                                                <div class="ripple-container"></div></button></td>
                                        <td><button type="button" rel="tooltip" title="" class="btn btn-primary btn-danger btn-link btn-lg" data-original-title="Delete Usuario">
